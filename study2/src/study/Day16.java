package study;
		/*
		 * Student클래스에는 이름을 출력해주는 반환값이 없는 name 메소드, 
		 * kor, eng, math를 정수형 매개변수로 입력받고, 호출한 메소드로 값을 반환해주는 sum 메소드, 
		 * 그리고 평균값을 반환해주는 avg메소드가 있습니다.
		 * 주석을 읽을때 Student클래스를 먼저 읽어주세요. 이해가 안되는 부분은 정리해두고 오늘 스터디 수업에서 해보겠습니다 :) 
		 */
		public class Day16 {
		
			public static void main(String[] args) {
				
				Student2 student = new Student2(); //Student클래스의 주소를 저장하기 위한 참조변수 student를 선언하고, Student클래스의 주소를 student참조변수에 저장해줍니다.
